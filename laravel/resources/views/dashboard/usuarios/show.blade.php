    ...
    <div class="col-lg-8">
        <div class="d-flex flex-column h-100 bg-light rounded-lg box-shadow-lg p-4">
            <div class="py-2 p-md-3">
                ...
                <form action="{{ route('dashboard.usuarios.update', ['usuario' => $user->id]) }}" method="post"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" id="role" name="role">
                                        <option value="cliente" {{ (old('role') == 'cliente' ||$user->role == 'cliente' ? 'selected' : '') }}>
                                            Cliente
                                        </option>
                                        <option value="médico" {{ (old('role') == 'médico' || $user->role == 'médico' ? 'selected' : '') }}>
                                            Médico
                                        </option>
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="custom-control custom-checkbox d-block">
                                    <input class="custom-control-input" type="checkbox" id="show-email" value="on"
                                           {{ (old('newsletter') == 'on' || old('newsletter') == true || $user->newsletter == 1 ? 'checked' : '') }} name="newsletter">
