...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
         ...
         * @param  {Object} dataPoint Data point to extract informacoes from
         * @private
         */
         ...
         * @param  {Object} dataPoint Data entry to extract informacoes
         * @return void
         */
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
         ...
         * @param  {Object} data Data value containing the informacoes
         ...
         * @param  {Object} dataPoint   Data entry from to take the informacoes
         * @return void
         * @private
         */
         ...
         *
         * @param  {lineChartPointByDate} dataPoint  Current datapoint to show informacoes about
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
         ...
         *
         * @param  {Object} dataPoint Current datapoint to show informacoes about
         * @return void
         */
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        /**
         * Creates coloured circles marking where the exact data y value is for a given data point
         * @param  {obj} dataPoint Data point to extract informacoes from
         * @private
         */
        ...
        /**
         * Helper method to update the x position of the vertical marker
         * @param  {obj} dataPoint Data entry to extract informacoes
         * @return void
         */
        function moveVerticalMarker(verticalMarkerXPosition) {
            verticalMarkerContainer.attr('transform', 'translate(' + verticalMarkerXPosition + ',0)');
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        /**
         * When a brush event starts, we can extract informacoes from the extension
         * of the brush.
         *
         * @return {void}
         */
