...
@section('content-top-right')
    <div>
        <form action="{{ route('admin.blog.destroy', ['blog' => $p->id]) }}" method="post">
            @csrf
            @method('DELETE')
            <a href="{{ route('admin.blog.show', ['blog' => $p->uri]) }}" class="btn btn-info btn-rounded">
                <i class="uil-arrow-left"></i> Voltar ao Artigo
            </a>
            <button type="submit" class="btn btn-danger btn-rounded" tabindex="0" data-toggle="popover" data-trigger="hover" title="" data-content="Ao deletar, o artigo é movido para a lixeira e é possível recupera-lo." data-original-title="Deletar">
                <i class="uil-trash-alt"></i> Deletar
            </button>
        </form>
    </div>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="simpleinput" class="form-control" placeholder="Dica: um bom título aumenta as chances do seu artigo ser aberto." maxlength="60" data-toggle="maxlength" data-threshold="20" data-placement="top" id="title" name="title" value="{{ old('title') ?? $p->title}}">
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="simpleinput" class="form-control" placeholder="Dica: o subtítulo serve para dar aos leitores uma visão geral do que terá no conteúdo artigo." maxlength="191" data-toggle="maxlength" data-threshold="91" data-placement="top" id="subtitle" name="subtitle" value="{{ old('subtitle') ?? $p->subtitle }}">
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea id="simplemde1" name="text" placeholder="Comece a digitar ...">{{ old('text') ?? $p->content }}</textarea>
                </div>
            </div>
